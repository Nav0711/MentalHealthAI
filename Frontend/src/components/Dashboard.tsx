...
const Dashboard: React.FC = () => {
  ...
  return (
    <div className="container px-4 py-8 max-w-6xl">
      <h1 className="text-3xl font-bold mb-6 mental-text">Mental Health Copilot</h1>
      
      <Tabs defaultValue="dashboard" className="w-full">
        <TabsList className="grid w-full grid-cols-3 mb-8" style={{ backgroundColor: themeColors.light }}>
          <TabsTrigger value="dashboard" className="transition-colors">Dashboard</TabsTrigger>
          <TabsTrigger value="chat" className="transition-colors">Chat</TabsTrigger>
          <TabsTrigger value="journal" className="transition-colors">Journal</TabsTrigger>
        </TabsList>
